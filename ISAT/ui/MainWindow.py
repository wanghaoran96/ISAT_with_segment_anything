...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # TODO 在这个窗口下面添加一个完全一致的窗口用来放action
        self.actions_dock = QtWidgets.QDockWidget(MainWindow)
        self.actions_dock.setObjectName("actions_dock")
        # self.actions_dock.setMinimumSize(QtCore.QSize(85, 43))
        self.dockWidgetContents_5 = QtWidgets.QWidget()
        self.dockWidgetContents_5.setObjectName("dockWidgetContents_5")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.dockWidgetContents_5)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.actions_dock.setWidget(self.dockWidgetContents_5)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(1), self.actions_dock)
        ...
        icon13_2.addPixmap(QtGui.QPixmap(":/icon/icons/M_Favicon3.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
