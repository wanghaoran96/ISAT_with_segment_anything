...
class Ui_Dialog_Action(object):
    def setupUi(self, Dialog):
        ...
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.action = QtWidgets.QLabel(self.widget_2)
        self.action.setMaximumSize(QtCore.QSize(120, 16777215))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(20)
        self.action.setFont(font)
        self.action.setObjectName("label")
        self.horizontalLayout_3.addWidget(self.action)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.verticalLayout.addWidget(self.widget_2)
        self.action_list_widget = QtWidgets.QListWidget(self.widget)
        self.action_list_widget.setObjectName("action_list_widget")
        self.verticalLayout.addWidget(self.action_list_widget)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.action_input = QtWidgets.QLineEdit(self.widget)
        self.action_input.setObjectName("action_input")
        self.horizontalLayout.addWidget(self.action_input)
        self.color_button = QtWidgets.QToolButton(self.widget)
        self.color_button.setStyleSheet("background-color: rgb(0, 255, 0);")
        self.color_button.setText("")
        self.color_button.setObjectName("color_button")
        ...
        self.horizontalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.action_label_config_file = QtWidgets.QLabel(self.widget_3)
        self.action_label_config_file.setText("")
        self.action_label_config_file.setAlignment(QtCore.Qt.AlignBottom | QtCore.Qt.AlignLeading | QtCore.Qt.AlignLeft)
        self.action_label_config_file.setObjectName("action label config file")
        self.horizontalLayout_4.addWidget(self.action_label_config_file)
        self.verticalLayout.addWidget(self.widget_3)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.pushButton_import = QtWidgets.QPushButton(self.widget)
    ...
    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Action Setting"))
        self.action.setText(_translate("Dialog", "Action"))
        self.add_button.setText(_translate("Dialog", "Add new label"))
        self.pushButton_import.setText(_translate("Dialog", "Import"))
        self.pushButton_export.setText(_translate("Dialog", "Export"))
        self.cancel_button.setText(_translate("Dialog", "Cancel"))
