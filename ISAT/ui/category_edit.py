...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.spinBox_group = QtWidgets.QSpinBox(self.widget_3)
        self.spinBox_group.setMaximum(9999)
        self.spinBox_group.setObjectName("spinBox_group")
        self.horizontalLayout_3.addWidget(self.spinBox_group)
...
class Ui_Dialog_Action(object):
    def setupUi(self, Dialog):
        ...
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_3.addWidget(self.label_2)
        self.lineEdit_action = QtWidgets.QLineEdit(self.widget_3)
        self.lineEdit_action.setAlignment(QtCore.Qt.AlignRight | QtCore.Qt.AlignTrailing | QtCore.Qt.AlignVCenter)
        self.lineEdit_action.setReadOnly(True)
        self.lineEdit_action.setObjectName("lineEdit_action")
        self.horizontalLayout_3.addWidget(self.lineEdit_action)
        self.action = QtWidgets.QLabel(self.widget_3)
        self.action.setMinimumSize(QtCore.QSize(50, 0))
        self.action.setMaximumSize(QtCore.QSize(50, 16777215))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.action.setText(_translate("Dialog", "group:"))
        self.label_3.setText(_translate("Dialog", "note:"))
        self.lineEdit_note.setPlaceholderText(_translate("Dialog", "add extra note here"))
        self.label_4.setText(_translate("Dialog", "layer:"))
        self.checkBox_iscrowded.setText(_translate("Dialog", "is crowded"))
