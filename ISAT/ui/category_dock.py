...
class Ui_Form_action(object):
    def setupUi(self, Form):
        ...
        self.verticalLayout.setSpacing(6)
        self.verticalLayout.setObjectName("verticalLayout")
        self.lineEdit_search_action = QtWidgets.QLineEdit(Form)
        self.lineEdit_search_action.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.lineEdit_search_action.setObjectName("lineEdit_search_action")
        self.verticalLayout.addWidget(self.lineEdit_search_action)
        self.listWidget = QtWidgets.QListWidget(Form)
        self.listWidget.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.listWidget.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.listWidget.setObjectName("listWidget")
        self.verticalLayout.addWidget(self.listWidget)
        self.pushButton_action_setting = QtWidgets.QPushButton(Form)
        self.pushButton_action_setting.setObjectName("pushButton_action_setting")
        self.verticalLayout.addWidget(self.pushButton_action_setting)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setContentsMargins(0, 0, -1, 0)
        self.horizontalLayout.setSpacing(6)
        self.horizontalLayout.setObjectName("horizontalLayout")
    ...
    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Form"))
        self.lineEdit_search_action.setPlaceholderText(_translate("Form", "Search actions."))
        self.pushButton_action_setting.setText(_translate("Form", "Action setting"))
        self.pushButton_group_mode.setStatusTip(_translate("Form", "Group mode"))
        self.pushButton_group_mode.setWhatsThis(_translate("Form", "Group mode"))
        self.pushButton_group_mode.setText(_translate("Form", "Auto"))
        self.pushButton_decrease.setStatusTip(_translate("Form", "Current group -"))
